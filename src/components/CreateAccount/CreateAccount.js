     ...
     return (
          <div >     
              <form onSubmit={onSubmit} className="ui form" id="createAccountForm">
                ...
                <div className="registrarme"><button className="ui teal button compact">Registrarme</button></div>
              </form>

              {error ? <p>Disculpa, se produjo un error inesperado, inténtalo nuevamente. </p> : null}
          </div>
     )
